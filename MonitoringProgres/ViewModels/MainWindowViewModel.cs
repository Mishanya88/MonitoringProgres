...
namespace MonitoringProgres.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Еремеев Михаил Юрьевич", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=1, Electric=2},
                new Student{Name="Родкин Илья Дмитриевич", Visual=2, Architecture=1, Networks=1, Calculate_Math=2, PI=2, Math=2, Electric=2},
                new Student{Name="Баньковский Вадим Игоревич", Visual=2, Architecture=1, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
